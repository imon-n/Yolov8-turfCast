...
def send_best_frame(frame):
    try:
        ...
        print("[ERROR] Frame send failed:", e)
...
def draw_overlay(frame, cam_idx, is_default, is_tracking):
    cv2.putText(frame, f"CAM: {cam_idx + 1}", (10, 25),
                cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 0), 2)

    status_text = "TRACKING BALL" if is_tracking else "DEFAULT VIEW"
...
while running:
    ...
    # ✅ SOCKET SEND (ADDED ONLY THIS LINE)

...
rtsp_urls = [
    ...
    "rtsp://admin:Stellar12@192.168.0.100:554/Streaming/Channels/101",  # NEW CAMERA
]
        ...
        for i, frame in enumerate(frames):
            ...
            if frame_id % DETECT_EVERY == 0:
                ...
                with lock:
                    ...
                    if best_box is None:
                        # fast decay when no ball
                        ema_scores[i] *= 0.5   # 🔥 decay faster (tune: 0.3–0.6)
                    else:
                        ema_scores[i] = EMA_ALPHA * best_area + (1 - EMA_ALPHA) * ema_scores[i]
